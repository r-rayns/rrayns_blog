...
```
<figcaption>The classes defining the spiders for the Liverpool Echo and the Manchester Evening News</figcaption>
...
```
<figcaption>The recursive _crawl function that is core to the looping of spiders</figcaption>
...
def parse_article(self, doc):
  ...
  return
```
<figcaption>The parse function</figcaption>
...
```
<figcaption>Extract function with two examples of the selector arrays</figcaption>
...
```
<figcaption>The classification function and example weightings</figcaption>
